...
Viene controllata la correttezza del codice confrontando il motodo di generazione utilizzato (Metropolis-Hastings o no) con il risultato finale. Se i valori coincidono, significa che il codice si è comportato correttamente. Durante la computazione, sarà possibile anche stampare certi risultati intermedi come la matrice iniziale generata.
